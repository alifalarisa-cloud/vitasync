...
const sidebarHTML = (activePage) => `
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <div class="sidebar-bottom">
      <button class="btn-add"><i class="fas fa-plus"></i> <span data-translate="add_supplement">Add Supplement</span></button>
      <div style="padding: 8px 16px; display: flex; gap: 8px;">
        <button onclick="changeLanguage('en')" style="flex:1; padding:4px; border:1px solid #ccc; border-radius:4px; font-size:11px; cursor:pointer;">EN</button>
        <button onclick="changeLanguage('id')" style="flex:1; padding:4px; border:1px solid #ccc; border-radius:4px; font-size:11px; cursor:pointer;">ID</button>
      </div>
    </div>
  </aside>
`;
...
const htmlFoot = `
    ...
    <div class="modal-content" style="width: 520px; max-width:90%; background:white; padding:24px; border-radius:16px; box-shadow:0 10px 30px rgba(0,0,0,0.15);">
      ...
      <div style="padding: 8px 0;">
        ...
        <div style="background:var(--primary-light); border:1px solid rgba(216,27,96,0.1); padding:14px; border-radius:10px; margin-bottom:16px;">
          ...
          <p style="font-size:12px; color:var(--text-muted); line-height:1.5; margin:0;">Optimal biological absorption is achieved when taken in accordance with specific mineral transporters.</p>
        </div>
        <div style="background:rgba(216,27,96,0.03); border:1px solid rgba(216,27,96,0.08); padding:14px; border-radius:10px; margin:0;">
          ...
          <p style="font-size:12px; color:var(--text-muted); line-height:1.5; margin:0;">Ensure a minimum spacing of 4 hours from competitive divalent metals.</p>
        </div>
      </div>
  ...
  <nav class="mobile-bottom-nav" id="mobileBottomNav">
    <a href="index.html"><i class="fas fa-th-large"></i><span>Home</span></a>
    <a href="schedule.html"><i class="far fa-calendar-alt"></i><span>Schedule</span></a>
    <a href="supplements.html"><i class="fas fa-pills"></i><span>Suplemen</span></a>
    <a href="biomarkers.html"><i class="fas fa-chart-line"></i><span>Biomarker</span></a>
    <a href="profile.html"><i class="fas fa-user"></i><span>Profil</span></a>
    <a href="#" id="mobileMenuBtn"><i class="fas fa-bars"></i><span>Menu</span></a>
  </nav>
  <script>
    (function() {
...
<main class="main-content">
  ...
  <div style="display:grid; grid-template-columns: 250px 1fr; gap:32px;">
    ...
    <div>
      <div style="display:grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap:24px;" id="insightsContainer">
        <!-- Dynamically rendered 20+ articles -->
      </div>
    </div>
  </div>
</main>
  ...
  <div style="display:grid; grid-template-columns: 1fr 1.5fr; gap:32px;">
    ...
    <div>
      <div class="card" style="text-align:center; padding:32px 24px; margin-bottom:24px; position:relative;">
        <button id="editProfileBtn" style="position:absolute; top:20px; right:20px; background:none; border:none; color:var(--primary-color); cursor:pointer; font-size:18px;"><i class="fas fa-pencil-alt"></i></button>
        
        <div style="width:120px; height:120px; border-radius:50%; overflow:hidden; margin:0 auto 16px; border:4px solid var(--primary-light); display:flex; align-items:center; justify-content:center;" id="profileImageContainer">
          <img src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?ixlib=rb-4.0.3&auto=format&fit=crop&w=200&q=80" alt="Avatar" style="width:100%; height:100%; object-fit:cover;">
        </div>
      ...
      <div class="card">
        <h3 style="margin-bottom:16px; font-size:16px; display:flex; justify-content:space-between; align-items:center;">
          <span>Health Conditions</span>
        </h3>
        <div style="display:flex; flex-wrap:wrap; gap:8px;" id="profileConditionsContainer">
          <!-- Dynamically populated conditions -->
        </div>
      </div>
    </div>
      ...
      <div class="card">
        ...
        <div style="display:flex; flex-direction:column; gap:20px;">
          <div style="display:flex; justify-content:space-between; align-items:center;">
            ...
            <input type="checkbox" checked style="width:24px; height:24px; cursor:pointer;">
          </div>
          <div style="display:flex; justify-content:space-between; align-items:center;">
            <div>
          ...
          <div style="display:flex; justify-content:space-between; align-items:center;">
            <div>
              <strong style="display:block;" data-translate="app_language">App Language</strong>
              <span style="font-size:12px; color:var(--text-muted);">Choose preferred translation</span>
            </div>
...
console.log('Insights and Profile HTML updated.');
